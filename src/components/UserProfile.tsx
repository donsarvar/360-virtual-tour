  ...
  if (!user) {
    return (
      <Button 
        onClick={handleLogin}
        variant="ghost" 
        className="glass hover:bg-white/10 text-white rounded-full px-4 py-2 flex items-center gap-2 border border-white/10 hover:border-white/20 transition-all pointer-events-auto active:scale-95 shadow-md"
      >
