...
const sourceDir = 'D:\\360 vertual loyiha\\360 images\\Islom Sivilizatsiya markazi';
const destDir = path.join(__dirname, 'public', 'islamic-center');
...
async function copyFiles() {
    console.log('Copying 17 Islamic Center 360 files...');
    for (let i = 1; i <= 17; i++) {
